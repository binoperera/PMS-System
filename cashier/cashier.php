...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Staff deleted!';
   }else{
      $warning_msg[] = 'Staff deleted already!';
   }
...
<section class="grid">
   ...
   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="search employees..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete staff" onclick="return confirm('delete this admin?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php } ?>
   <?php
