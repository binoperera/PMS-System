...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa fa-credit-card-alt" aria-hidden="true"></i><span><?= $fetch_property['price']; ?></span>LKR</p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span>LKR</p>
