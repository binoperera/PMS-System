...
if(isset($_POST['post'])){
  ...
  # $user_number = $_POST['user_number'];
   #$user_number = filter_var($user_number, FILTER_SANITIZE_STRING);
   #$payment_type = $_POST['payment_type'];
   #$payment_type = filter_var($payment_type, FILTER_SANITIZE_STRING);
  # $payment_price = $_POST['payment_price'];
   #$payment_price = filter_var($payment_price, FILTER_SANITIZE_STRING);
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id,user_id, property_name, address, price, type, offer, status, furnished, deposite, bedroom, bathroom, balcony, age, total_floors, room_floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $deposite, $bedroom, $bathroom, $balcony, $age, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            <p>Property Price  Rs.<span>*</span></p>
         ...
         <div class="box">
            ...
            <select name="bedroom" required class="input">
               <option value="0">Not Avaialable</option>
      ...
      <div class="flex"> 
        ...
        <section class="faq" id="faq">
               <div class="box-container">
                  ...
                  <h3><span>IPMORTANT</span><i class="fas fa-angle-down"></i></h3>
                  <p>When you post your property through <span>Bodima.lk</span>, <br> Free for the <span>First day</span> <br> Your choice of <span>Easy Promo</span> package is valid for only <span>15 Days</span> & <span>Promo</span> package is valid for <span>30 Days</span> <br> You make the due payment. Otherwise, our admins will remove your property from the website </p>
                  <p>If you are posting per day , Please ignore this</p>
                  <p> IF YOU WANT TO LOGIN FOR TIME SERVICES FIRST CLICK HERE<a href="payment.php" class="btn">Payment</a></p>
                  </div>
               </div>
         </section>
